// =========================================================
// SUPABASE ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ
// =========================================================
...
ÃÂ¯ÃÂ»ÃÂ¿const STORAGE_KEY = "tomosu-state-v1";
const CURRENT_STORAGE_KEY = "streakgarden-state-v1";
const LEGACY_STORAGE_KEYS = [STORAGE_KEY];
const PLAN_RANK = { C: 1, B: 2, A: 3 };
const PLAN_META = {
  A: { label: "Plan A", tag: "ÃÂ©ÃÂÃÂÃÂ¥ÃÂ¸ÃÂ¸" },
  B: { label: "Plan B", tag: "ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ®" },
  C: { label: "Plan C", tag: "ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂ" },
};
const REASONS = [
  ...
  "ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¢ÃÂ¥ÃÂÃÂ",
  "ÃÂ§ÃÂÃÂ²ÃÂ¥ÃÂÃÂ´",
  "ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´",
  "ÃÂ¥ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
];
const REPLAN_MODES = {
  lighten_today: "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ¨ÃÂ»ÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  reset_week: "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂÃÂ§ÃÂ«ÃÂÃÂ£ÃÂÃÂ¦ÃÂ§ÃÂÃÂ´ÃÂ£ÃÂÃÂ",
  break_goal: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  retarget_goal: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  consult_block: "ÃÂ¨ÃÂ©ÃÂ°ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ¸ÃÂ¨ÃÂ«ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
};
const SETUP_SECTIONS = {
  goal: {
    label: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂ",
    hint: "ÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ´ÃÂ£ÃÂÃÂ",
    title: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂ",
    copy: "ÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  },
  roadmap: {
    label: "Roadmap",
    hint: "ÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    title: "Roadmap",
    copy: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂ¨ÃÂ¨ÃÂªÃÂ¿ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  },
  schedule: {
    label: "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ",
    hint: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    title: "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ",
    copy: "ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  },
  plan: {
    label: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´",
    hint: "ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ»ÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    title: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³",
    copy: "ÃÂ©ÃÂÃÂÃÂ¥ÃÂ¸ÃÂ¸ / ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ® / ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®3ÃÂ¦ÃÂ®ÃÂµÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂªÃÂ¿ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  },
};
...
const FLOWER_STAGE_LABELS = ["ÃÂ§ÃÂ¨ÃÂ®", "ÃÂ¨ÃÂÃÂ½", "ÃÂ¥ÃÂÃÂÃÂ¨ÃÂÃÂ", "ÃÂ¨ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ³", "ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿", "ÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂ", "ÃÂ¥ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂ", "ÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ²ÃÂ£ÃÂÃÂ", "ÃÂ¦ÃÂºÃÂÃÂ©ÃÂÃÂ", "ÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ±"];
// ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ©ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂªÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¢ÃÂÃÂ£ÃÂÃÂ»ÃÂ¦ÃÂ¡ÃÂÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
const FLOWER_LIBRARY = {
  ume: {
    label: "ÃÂ¦ÃÂ¢ÃÂ",
    trait: "ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¥ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ",
  ...
  sakura: {
    label: "ÃÂ¦ÃÂ¡ÃÂ",
    trait: "ÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ§ÃÂ¥ÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ",
    copy: "ÃÂ¥ÃÂ¤ÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¬ÃÂ§ÃÂÃÂªÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ¦ÃÂºÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ¬ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¾ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¤ÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ©ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  ...
  satsuki: {
    ...
    trait: "ÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ",
    copy: "ÃÂ¦ÃÂ®ÃÂµÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¨ÃÂÃÂ±ÃÂ£ÃÂÃÂÃÂ¥ÃÂ¢ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ¥ÃÂ¼ÃÂµÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
...
const BONSAI_LIBRARY = {
  pine: {
    label: "ÃÂ¦ÃÂÃÂ¾", trait: "ÃÂ§ÃÂ©ÃÂÃÂ£ÃÂÃÂ¿ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£",
    trunk: "#5a4a3a", branch: "#4a3c2c",
    foliage: "#2e6644", foliageDark: "#1e4e32", foliageLight: "#4e8e5c",
    pot: "#8c6e58", potRim: "#7a5c48", soil: "#6a5040",
  },
  maple: {
    label: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ", trait: "ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£",
    trunk: "#7a5840", branch: "#6a4c36",
    foliage: "#c04020", foliageDark: "#8a2c14", foliageLight: "#f08040",
    pot: "#906858", potRim: "#7e5848", soil: "#6e5038",
  },
  moss: {
    label: "ÃÂ¨ÃÂÃÂ", trait: "ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£",
    trunk: "#5a7040", branch: "#4a6030",
    foliage: "#5a9040", foliageDark: "#3a6828", foliageLight: "#8abf60",
    pot: "#7a8060", potRim: "#6a7050", soil: "#5a6040",
  },
};
const BONSAI_STAGE_LABELS = ["ÃÂ©ÃÂÃÂ¢ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¿","ÃÂ¨ÃÂÃÂ½ÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂ","ÃÂ¥ÃÂ¹ÃÂ¼ÃÂ¦ÃÂÃÂ¨","ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂ","ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ","ÃÂ¦ÃÂ¨ÃÂ¹ÃÂ¥ÃÂ½ÃÂ¢ÃÂ¦ÃÂÃÂ","ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂ","ÃÂ¨ÃÂÃÂÃÂ¦ÃÂÃÂ","ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂ¨","ÃÂ¥ÃÂÃÂÃÂ¤ÃÂ½ÃÂ"];
...
function inferDefaultFlowerType(setup = {}) {
  ...
  if (/ÃÂ¥ÃÂ§ÃÂ|ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂ|ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ|first|week|ÃÂ©ÃÂÃÂ±|1ÃÂ©ÃÂÃÂ±/.test(goalText)) {
    return "ume";
  }
  if (/ÃÂ¨ÃÂ©ÃÂ¦ÃÂ©ÃÂ¨ÃÂ|ÃÂ¥ÃÂÃÂÃÂ©ÃÂ¨ÃÂ|ÃÂ§ÃÂÃÂºÃÂ¨ÃÂ¡ÃÂ¨|ÃÂ¦ÃÂÃÂ¬ÃÂ§ÃÂÃÂª|ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³|ÃÂ©ÃÂÃÂ¢ÃÂ¦ÃÂÃÂ¥|ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂº|exam|test/.test(goalText)) {
    return "sakura";
  }
  return "satsuki";
}
...
function formatStudyDays(studyDays) {
  ...
  if (!days.length) {
    return "ÃÂ¦ÃÂÃÂªÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ";
  }
...
function formatDeadlineBadge(deadline) {
  ...
  return normalized ? `ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${normalized}` : "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ";
}
...
// ÃÂ§ÃÂÃÂ´ÃÂ¨ÃÂ¿ÃÂ7ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¨ÃÂªÃÂ¬ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ§ÃÂÃÂ®ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂÃÂ¶UIÃÂ¯ÃÂ¼ÃÂ
function renderStreakDots(logs, studyDays) {
  ...
  // 7ÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂªÃÂ¦ÃÂºÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂ·ÃÂ¦ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
...
function bindEvents() {
  // ç»é¢ã®åãåãæ¿ãæã«ãã¥ã¼ãã¼ãé«ããåè¨ç®
  updateVH();
...
function handleKeydown(event) {
  ...
  if (viewIndex >= 0 && viewIndex < tabViews.length) {
    if (state.activeSession) {
      ui.sessionOpen = true;
      render();
      showToast("ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ·ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ³ÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
      return;
    }
...
function handleClick(event) {
  ...
  if (action === "open-setup") {
    if (state.activeSession) {
      ui.sessionOpen = true;
      render();
      showToast("ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ·ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ³ÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
      return;
    }
    ui.setupMode = "edit";
  ...
  if (action === "activate-goal") {
    if (activateGoal(target.dataset.goalId || "")) {
      ui.goalLibraryDraft = null;
      render();
      showToast("ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    }
    return;
  }

  // ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ¸ÃÂ§ÃÂ§ÃÂ»ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ¤ÃÂ¿ÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¯ÃÂ¼ÃÂ
  if (action === "archive-goal") {
    ...
    // ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¨ÃÂ±ÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¸ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¿ÃÂ£ÃÂÃÂ
    ...
    saveState();
    render();
    showToast("ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ«ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }

  // ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ
  ...
  // ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ¥ÃÂ¾ÃÂÃÂ¯ÃÂ¼ÃÂ
  if (action === "delete-goal") {
    ...
    saveState();
    render();
    showToast("ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
  ...
  if (action === "save-goal-library-edit") {
    ...
    render();
    showToast("ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
  ...
  if (action === "toggle-study-day") {
    ...
    if (!nextDays.length) {
      showToast("ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ1ÃÂ£ÃÂÃÂ¤ÃÂ¤ÃÂ»ÃÂ¥ÃÂ¤ÃÂ¸ÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
      return;
    }
  ...
  if (action === "save-setup") {
    ...
    if (saveResult === "created" && conflicts.length) {
      showToast(`ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ ${conflicts.map((item) => item.label).join(" / ")} ÃÂ£ÃÂÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`);
    } else if (saveResult === "created") {
      showToast("ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ¢ÃÂ£ÃÂÃÂ§ÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  ...
  if (action === "quick-start-session") {
    ...
    ui.sessionOpen = true;
    render();
    showToast(`${PLAN_META[launchPlanKey].label}ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`);
    return;
  }
  ...
  if (action === "begin-session") {
    ...
    render();
    showToast(`${PLAN_META[ui.selectedSessionPlan].label}ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`);
    return;
  }
  ...
  if (action === "abort-session") {
    ...
    saveState();
    render();
    showToast(`ã»ãã·ã§ã³ãåãæ¶ãã¾ããã`);
    return;
  }
  ...
  if (action === "lighten-today") {
    ...
    saveState();
    render();
    showToast(`ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯${PLAN_META[state.today.recommendedPlan].label}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`);
    return;
  }
  ...
  if (action === "confirm-miss") {
    ...
    ui.missPanelOpen = false;
    render();
    showToast("ÃÂ¦ÃÂÃÂªÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¾ÃÂ©ÃÂ¥ÃÂ¸ÃÂ°ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ»ÃÂ¥ÃÂ½ÃÂ¹ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
  ...
  if (action === "habit-checkin") {
    ...
    saveState();
    render();
    showToast("ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ");
    return;
  }
  ...
  if (action === "undo-log-date") {
    ...
    render();
    showToast(removed ? `ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ: ${buildLogSummary(removed)}` : "ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
  ...
  if (action === "open-review-log-editor") {
    ...
    render();
    showToast(opened ? "ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
  ...
  if (action === "save-review-log") {
    ...
    render();
    showToast(saved ? "ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¨ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return;
  }
...
function render() {
  ...
  setupShortcut.textContent = currentView === "setup" ? "ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ";
  ...
  try {
    ...
    screenRoot.innerHTML = `<div class="screen" style="padding:32px 24px;text-align:center;"><p style="font-size:1.1rem;margin-bottom:8px;">ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂºÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p><p style="font-size:0.82rem;color:var(--muted)">${escapeHtml(String(err.message || err))}</p></div>`;
  }
  renderSessionSheet();
  startSessionTicker();
...
function renderEditableScheduleRow(item, draft) {
  const statusBadge = item.isActive
    ? `<span class="status-badge status-badge--done">ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¤ÃÂ¸ÃÂ­</span>`
    : `<span class="status-badge ${item.overlaps ? "status-badge--danger" : ""}">${item.overlaps ? "ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ" : item.sharedDays.length ? "ÃÂ¥ÃÂÃÂ¥ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ" : "ÃÂ¥ÃÂÃÂ¥ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥"}</span>`;
    ...
    <article class="goal-window-row ${item.isActive ? "is-active" : ""} ${item.overlaps ? "is-conflict" : ""}">
      <div class="goal-window-row__head">
        <div class="goal-window-row__body">
          ...
          <div class="goal-window-row__meta">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${escapeHtml(item.window)} / ${escapeHtml(formatStudyDays(item.studyDays))}</div>
        </div>
        <div class="goal-window-row__actions">
          ${statusBadge}
          ${item.isActive
            ? ""
            : `<button type="button" class="soft-button goal-window-row__pick" data-action="activate-goal" data-goal-id="${escapeHtml(item.id)}">ÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>`}
        </div>
      </div>
      ${item.isActive
        ? `
          <div class="goal-window-row__editor">
            ${renderWindowField("ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ", "primaryStart", "primaryEnd", draft.primaryStart, draft.primaryEnd)}
            <div class="field">
              <span class="field__label">ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥</span>
              ...
              <p class="goal-window-row__current">ÃÂ§ÃÂÃÂ¾ÃÂ¥ÃÂÃÂ¨: ${escapeHtml(formatStudyDays(draft.studyDays))}</p>
            </div>
            <div class="goal-window-row__save">
              <button type="button" class="action-button action-button--primary" data-action="save-setup">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ®ÃÂ¹ÃÂ£ÃÂÃÂ§ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂ</button>
            </div>
          </div>
        `
        : ""}
...
function renderPrimaryWindowRoster(draft) {
  ...
  const warningText = conflicts.length
    ? (isNewGoal
      ? "ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂªÃÂ¿ÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"
      : `ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ ${conflicts.map((item) => item.label).join(" / ")} ÃÂ£ÃÂÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`)
    : "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ";
    ...
    return `
      <div class="stack setup-schedule-roster">
        <div class="setup-section-intro">
          <h3 class="section-title">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂ§</h3>
          <p class="section-copy">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
        </div>
  ...
  return `
    <div class="stack setup-schedule-roster">
      <div class="setup-section-intro">
        <h3 class="section-title">ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ</h3>
        <p class="section-copy">ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ1ÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ±ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂ£ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
      </div>
      ${roster.length
        ? `
            ...
            ${roster.map((item) => `
              <div class="goal-window-row ${item.overlaps && !isNewGoal ? "is-conflict" : ""}">
                <div class="goal-window-row__head">
                  ...
                  <div class="goal-window-row__actions">
                    <span class="status-badge ${item.overlaps && !isNewGoal ? "status-badge--danger" : ""}">${item.overlaps ? (isNewGoal ? "ÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂªÃÂ¿ÃÂ¦ÃÂÃÂ´" : "ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ") : (item.sharedDays.length ? "ÃÂ¥ÃÂÃÂ¥ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ" : "ÃÂ¥ÃÂÃÂ¥ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥")}</span>
                  </div>
                </div>
              </div>
            `).join("")}
        ...
        `
        : `<p class="section-copy">ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>`}
      <p class="setup-warning ${warningClass}">${escapeHtml(warningText)}</p>
    </div>
  `;
}
function renderSetupSectionBody(section, draft) {
  if (section === "schedule") {
    ...
    return `
      <div class="stack setup-schedule">
        ...
        <div class="field">
          <span class="field__label">ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥</span>
          <p class="section-copy">Today ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
          <div class="weekday-choice-row">
            ${WEEKDAY_KEYS.map((weekdayKey) => renderWeekdayChip(weekdayKey, draft.studyDays)).join("")}
          </div>
          <p class="section-copy">ÃÂ§ÃÂÃÂ¾ÃÂ¥ÃÂÃÂ¨: ${escapeHtml(formatStudyDays(draft.studyDays))}</p>
        </div>
        ${renderWindowField("ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ", "primaryStart", "primaryEnd", draft.primaryStart, draft.primaryEnd)}
      </div>
    `;
  ...
  if (section === "roadmap") {
    return `
      <div class="stack">
        <div class="setup-section-intro">
          <h3 class="section-title">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³</h3>
          <p class="section-copy">Roadmap ÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ¢ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
        </div>
  ...
  if (section === "plan") {
    return `
      <div class="plan-list">
        ${renderEditablePlanCard("A", "normalMinutes", draft.normalMinutes, "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¦ÃÂºÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³")}
        ${renderEditablePlanCard("B", "shortMinutes", draft.shortMinutes, "ÃÂ¥ÃÂ°ÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ»ÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³")}
        ${renderEditablePlanCard("C", "minimumMinutes", draft.minimumMinutes, "ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³")}
      </div>
    `;
  }
  ...
  return `
    <div class="stack">
      <p class="section-copy">ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂ® Today ÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
      <div class="field">
        <span class="field__label">ÃÂ§ÃÂ¨ÃÂ®ÃÂ©ÃÂ¡ÃÂ</span>
        <div class="goal-type-toggle">
          <button type="button" class="goal-type-btn ${!isHabitDraft ? "is-active" : ""}" data-action="select-goal-type" data-goal-type="goal">
            <span class="goal-type-btn__icon">ÃÂ°ÃÂÃÂÃÂ¯</span>
          ...
          <button type="button" class="goal-type-btn ${isHabitDraft ? "is-active" : ""}" data-action="select-goal-type" data-goal-type="habit">
            <span class="goal-type-btn__icon">ÃÂ°ÃÂÃÂÃÂ¿</span>
            <span class="goal-type-btn__label">ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£</span>
          </button>
        </div>
      </div>
      <label class="field">
      ...
      ${!isHabitDraft ? `
        <div class="field">
          <span class="field__label">ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ§ÃÂ©ÃÂºÃÂ¦ÃÂ¬ÃÂÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</span>
        ...
        <p class="section-copy">ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ Roadmap / ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ / ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ¦ÃÂ±ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
      ` : `
        ${renderBonsaiPicker(draft.bonsaiKey)}
        <p class="section-copy">ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ Roadmap ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¯ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ§ÃÂ§ÃÂÃÂÃÂ¦ÃÂ ÃÂ½ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
      `}
    </div>
  `;
}
...
function renderGoalLibrary() {
  ...
  const intro = ui.setupMode === "new_goal"
    ? "ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¦ÃÂ§ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂToday ÃÂ£ÃÂÃÂ¯ÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"
    : "ÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¼ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂ¸ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ";
      ...
      <div class="goal-library">
        ${goals.map((goal) => {
          ...
          const meta = isHabitGoal
            ? `ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ / ${bonsaiMeta.label}`
            : `${formatDeadlineBadge(deadlineText)} / ÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ© ${flower.label}`;
          return `
            <article class="goal-library-card ${isActive ? "is-active" : ""}">
              <div class="goal-library-card__head">
                ...
                <span class="status-badge ${isActive ? "status-badge--done" : ""}">${isActive ? "ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¤ÃÂ¸ÃÂ­" : "ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿"}</span>
              </div>
              ${isEditing
                ? `
                  <div class="goal-library-card__editor">
                    ...
                    <div class="goal-library-card__actions">
                      <button type="button" class="soft-button goal-library-card__action" data-action="save-goal-library-edit">ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂ</button>
                      <button type="button" class="soft-button goal-library-card__action" data-action="cancel-goal-library-edit">ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                    </div>
                  </div>
                `
                : ui.deleteConfirmGoalId === goal.id
                  ? `
                    <p class="goal-library-card__delete-warn">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
                    <div class="goal-library-card__actions">
                      <button type="button" class="soft-button goal-library-card__action goal-library-card__action--danger" data-action="delete-goal" data-goal-id="${goal.id}">ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                      <button type="button" class="soft-button goal-library-card__action" data-action="cancel-delete-goal">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                    </div>
                  `
                  : `
                    <p class="goal-library-card__meta">${escapeHtml(meta)}</p>
                    ${isActive ? `<p class="goal-library-card__note">${escapeHtml(isGoalScheduledForDate(goal) ? "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¯ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ® Today ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¨ÃÂ±ÃÂ¡ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ")}</p>` : ""}
                    <div class="goal-library-card__actions">
                      <button type="button" class="soft-button goal-library-card__action" data-action="start-goal-library-edit" data-goal-id="${goal.id}">ÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂ</button>
                      <button type="button" class="soft-button goal-library-card__action" data-action="archive-goal" data-goal-id="${goal.id}">ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ¸</button>
                      <button type="button" class="soft-button goal-library-card__action goal-library-card__action--danger" data-action="confirm-delete-goal" data-goal-id="${goal.id}">ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»</button>
                    </div>
                  `}
            </article>
          `;
    ...
    <section class="focus-launch focus-launch--minimal${cardClass}" data-action="select-goal" data-goal-id="${goal.id}" role="button" tabindex="0" style="view-transition-name: goal-card-${goal.id}">
      ...
      <div class="focus-launch__goal-meta">
        <div class="focus-launch__status-row">
          <span class="status-badge ${escapeHtml(missionState.badgeClass || "")}">${escapeHtml(missionState.isClosed ? "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : missionState.badge)}</span>
        </div>
        <div class="focus-launch__goal-timing">
          ...
          <span class="focus-launch__goal-slot">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${escapeHtml(goal.setup.primaryWindow)}</span>
        </div>
      </div>
          ...
          .map(
            (planKey) => `
              <button type="button" class="pill-button focus-plan-button ${selectedPlanKey === planKey ? "is-active" : ""}" data-action="launch-session-plan" data-goal-id="${goal.id}" data-plan="${planKey}">
                ...
                <span class="focus-plan-button__meta">${PLAN_META[planKey].tag} / ${goal.plans[planKey].minutes}ÃÂ¥ÃÂÃÂ</span>
              </button>
            `,
          )
          .join("")}
...
function renderTodayHabitCard(goal, index) {
  ...
  return `
    <section class="focus-launch focus-launch--minimal focus-launch--habit${cardClass}" style="view-transition-name: goal-card-${goal.id}">
      ...
      <div class="focus-launch__goal-meta">
        <div class="focus-launch__status-row">
          <span class="status-badge ${isDone ? "status-badge--done" : "status-badge--accent"}">${isDone ? "ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : "ÃÂ¦ÃÂÃÂªÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ"}</span>
          <span class="status-badge">ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£</span>
        </div>
        <div class="focus-launch__goal-timing">
          <span class="focus-launch__goal-slot">${escapeHtml(bonsaiMeta.label)} / ${escapeHtml(growth.stageLabel)}</span>
          ${(() => { const w = goal.setup.primaryWindow || (goal.setup.primaryStart && goal.setup.primaryEnd ? `${goal.setup.primaryStart}-${goal.setup.primaryEnd}` : ""); return w ? `<span class="focus-launch__goal-slot">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${escapeHtml(w)}</span>` : ""; })()}
        </div>
      </div>
      <div class="focus-launch__title-row">
        <h1 class="focus-launch__goal focus-launch__goal--solo">${escapeHtml(goal.setup.goal)}</h1>
...
function renderActiveGoalContext(options = {}) {
  ...
  return `
    <details class="goal-selector">
      <summary>
        <span class="hero__context goal-selector__current">ÃÂ¥ÃÂ¯ÃÂ¾ÃÂ¨ÃÂ±ÃÂ¡ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ: ${escapeHtml(state.setup.goal)}</span>
        <span class="goal-selector__button">ÃÂ©ÃÂÃÂ¸ÃÂ¦ÃÂÃÂ</span>
      </summary>
        ...
        ${goals.map((goal) => {
          ...
          return `
            ...
            >
              ...
              <span class="goal-selector__option-state">${isActive ? "ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¤ÃÂ¸ÃÂ­" : "ÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂ¶"}</span>
            </button>
          `;
        }).join("")}
      </div>
...
function renderSetupView() {
  ...
  const saveLabel = state.meta.demoMode || isNewGoal ? "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ®ÃÂ¹ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ";
  const sectionTitle = activeSectionKey === "goal" ? (isNewGoal ? "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ " : "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂ") : activeSection.title;
  const newGoalSectionCopy = {
    roadmap: "ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂ±ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    schedule: "ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¨ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂ±ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    plan: "ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ® Plan A / B / C ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂ±ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  };
  const sectionCopy = activeSectionKey === "goal"
    ? (isNewGoal ? "ÃÂ¤ÃÂ»ÃÂÃÂ£ÃÂÃÂ® Today ÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : activeSection.copy)
  ...
  const setupMenu = [
    renderSetupMenuItem({
      ...
      section: "goal",
      label: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ",
      hint: "ÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¢ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      iconKey: "add",
    ...
    renderSetupMenuItem({
      ...
      section: "plan",
      label: "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³",
      hint: "A / B / C ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¹ÃÂ",
      iconKey: "plan",
      ...
      <section class="setup-layout setup-layout--menu">
        <aside class="setup-nav setup-nav--menu">
          <div class="setup-nav__lead">
            ...
            <strong>ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂ¶</strong>
          </div>
          <div class="setup-nav__list">${setupMenu}</div>
          <div class="setup-nav__data-actions">
            <button type="button" class="ghost-button setup-nav__data-btn" data-action="export-data">ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ</button>
            <button type="button" class="ghost-button setup-nav__data-btn" data-action="import-data">ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ</button>
          </div>
        </aside>
        ...
        <section class="panel panel--warm stack setup-stage">
          <div class="setup-stage__header">
            ...
            <div class="setup-stage__copy">
              ${isNewGoal ? '<span class="status-badge status-badge--accent">ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ¤ÃÂ¸ÃÂ­</span>' : ""}
        ...
        ${goals.length
          ...
          : `
            <section class="panel panel--warm stack">
              <span class="status-badge">ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯${escapeHtml(weekdayLabel(todayKey))}</span>
              <h2 class="section-title">ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</h2>
              <p class="section-copy">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ ${escapeHtml(weekdayLabel(todayKey))} ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ Today ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
            </section>
          `}
      </div>
    </section>
...
function getTodayMissionState(currentState, todayLog) {
  if (!todayLog) {
    return {
      ...
      badge: "ÃÂ¦ÃÂÃÂªÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ",
      title: "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂµÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      detail: "ÃÂ§ÃÂµÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      showPendingCue: true,
      isClosed: false,
    };
  }
  ...
  if (!isSameMissionLog(currentState, todayLog)) {
    return {
      panelClass: "panel--focus",
      badgeClass: "status-badge--accent",
      badge: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ¥ÃÂ¾ÃÂ",
      title: "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      detail: `ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²: ${buildLogSummary(todayLog)}`,
      showPendingCue: true,
      isClosed: false,
    };
  }
  ...
  if (todayLog.outcome === "miss") {
    return {
      ...
      badge: "ÃÂ¦ÃÂÃÂªÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½",
      title: "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  ...
  return {
    ...
    badge: "ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿",
    title: "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    detail: buildLogSummary(todayLog),
...
function renderRoadmapMilestoneCard(milestone, index, options = {}) {
  ...
  const deadlineLabel = milestone.deadline ? `ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${milestone.deadline}` : "";
  const targetLabel = Number.isFinite(Number(milestone.target)) ? `ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ½ÃÂÃÂ§ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂ ${Math.round(Number(milestone.target))}%` : "";
      ...
      <div class="panel milestone__panel">
        ...
        ${editable ? `
          <div class="milestone__actions milestone__actions--compact">
            <button type="button" class="ghost-button" data-action="open-roadmap-editor" data-roadmap-id="${escapeHtml(milestone.id)}">ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£</button>
            <button type="button" class="ghost-button" data-action="delete-roadmap-item" data-roadmap-id="${escapeHtml(milestone.id)}">ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂ¤</button>
          </div>
        ` : ""}
      </div>
    </article>
...
function renderRoadmapInsertSlot(afterId = "") {
  ...
  return `
    <article class="milestone milestone--insert" data-step="+">
      <button type="button" class="milestone-add-button" data-action="open-roadmap-editor" aria-label="ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ "${afterAttr}></button>
    </article>
  `;
}
...
function renderRoadmapMilestoneList(roadmap, options = {}) {
  ...
  if (!roadmap.milestones.length) {
    return editable
      ...
      `
      : `<p class="preview-empty">ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>`;
  }
  ...
  // ÃÂ©ÃÂÃÂ²ÃÂ¨ÃÂ¦ÃÂ§ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ: ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ£ÃÂÃÂ´ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂ ÃÂÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂºÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¯ÃÂ©ÃÂÃÂÃÂ©ÃÂ ÃÂÃÂ¯ÃÂ¼ÃÂ
...
function renderRoadmapCurrentStatus(roadmap) {
  ...
  if (!milestone) {
    return `<p class="preview-empty">ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>`;
  }
  ...
  const statusLabel = milestone.isComplete ? "ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : "ÃÂ©ÃÂÃÂ²ÃÂ¨ÃÂ¡ÃÂÃÂ¤ÃÂ¸ÃÂ­";
  const deadlineLabel = milestone.deadline ? `ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${milestone.deadline}` : "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ";
    ...
    <article class="roadmap-focus-card">
      <div class="roadmap-focus-card__head">
        ...
        <div class="roadmap-focus-card__value-block">
          ...
          <span class="roadmap-focus-card__value-label">ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ½ÃÂÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂÃÂ</span>
        </div>
      </div>
    ...
    <section class="screen">
      ...
      <section class="panel panel--cool stack">
        <div class="status-strip">
          <span class="status-badge">${roadmap.daysRemaining == null ? "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ" : `ÃÂ¦ÃÂ®ÃÂÃÂ£ÃÂÃÂ ${formatRemainingSpan(roadmap.daysRemaining)}`}</span>
        </div>
        <div>
          <h2 class="section-title">ÃÂ§ÃÂÃÂ¾ÃÂ¥ÃÂÃÂ¨ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ§ÃÂÃÂ¶ÃÂ¦ÃÂ³ÃÂ</h2>
        </div>
        ${renderRoadmapCurrentStatus(roadmap)}
        <div>
          <h2 class="section-title">ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</h2>
        </div>
...
function renderHabitStreakRoadmap() {
  ...
  const milestones = [
    { days: 7,   label: "7ÃÂ¦ÃÂÃÂ¥",   desc: "ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ£ÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",       emoji: "ÃÂ°ÃÂÃÂÃÂ±" },
    { days: 21,  label: "21ÃÂ¦ÃÂÃÂ¥",  desc: "ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂºÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",   emoji: "ÃÂ°ÃÂÃÂªÃÂ´" },
    { days: 66,  label: "66ÃÂ¦ÃÂÃÂ¥",  desc: "ÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ£",         emoji: "ÃÂ°ÃÂÃÂÃÂ³" },
    { days: 100, label: "100ÃÂ¦ÃÂÃÂ¥", desc: "ÃÂ¦ÃÂÃÂ¬ÃÂ§ÃÂÃÂ©ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ£ÃÂÃÂ¸",           emoji: "ÃÂ°ÃÂÃÂÃÂ" },
    { days: 365, label: "1ÃÂ¥ÃÂ¹ÃÂ´",   desc: "ÃÂ¤ÃÂºÃÂºÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ",         emoji: "ÃÂ¢ÃÂÃÂ©ÃÂ¯ÃÂ¸ÃÂ" },
  ];
    ...
    <section class="screen">
      ...
      <section class="panel panel--cool stack">
        ...
        <div style="text-align:center;padding:8px 0 4px">
          ...
          <p style="font-size:0.85rem;color:var(--muted);margin:4px 0 0">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ°</p>
        </div>
        ${nextMilestone ? `<div style="font-size:0.82rem;color:var(--muted);text-align:center">ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ${escapeHtml(nextMilestone.label)}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ <strong style="color:var(--ink)">${daysToNext}ÃÂ¦ÃÂÃÂ¥</strong></div>` : `<div style="font-size:0.88rem;text-align:center;color:var(--accent)">ÃÂ°ÃÂÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</div>`}
      </section>
      <section class="panel stack">
        <h2 class="section-title">ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ</h2>
              ...
              <div style="display:flex;align-items:center;gap:10px;margin-bottom:${isCurrent ? "8px" : "0"}">
                ...
                <div style="flex:1">
                  <div style="display:flex;justify-content:space-between;align-items:baseline">
                    ...
                    <span style="font-size:0.78rem;color:var(--muted)">${done ? "ÃÂ¢ÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂ" : `${executedDays}/${m.days}ÃÂ¦ÃÂÃÂ¥`}</span>
                  </div>
  ...
  return `
    <article class="milestone milestone--editor" data-step="${escapeHtml(String(stepLabel))}">
      <section class="panel panel--warm stack milestone-editor">
        <div>
          <h2 class="panel__title">${isEdit ? "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£" : "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ "}</h2>
        </div>
        <label class="field">
          <span class="field__label">ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«</span>
          <input class="field__control" data-roadmap-field="label" type="text" value="${escapeHtml(draft.label || "")}" placeholder="ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ©ÃÂ¦ÃÂ£ÃÂÃÂ§70% / 3ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨ ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ©" />
        </label>
        ...
        ${isGoalItem ? '<p class="section-copy">ÃÂ¦ÃÂÃÂÃÂ§ÃÂµÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ§ÃÂ·ÃÂ¨ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>' : ''}
        <div class="action-row milestone-editor__actions">
          <button type="button" class="action-button action-button--primary" data-action="save-roadmap-item">${isEdit ? "ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂ" : "ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"}</button>
          <button type="button" class="soft-button" data-action="cancel-roadmap-editor">ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
        </div>
      </section>
    </article>
  `;
    ...
    <section class="screen">
      ...
      <section class="panel stack">
        <div class="metric-grid">
          ${renderMetricCard("7ÃÂ¦ÃÂÃÂ¥ÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂ¡ÃÂÃÂ§ÃÂÃÂ", metrics.executionRate)}
          ${renderMetricCard("ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ·ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ", formatLoggedDuration(totalStudySeconds), "")}
        </div>
      </section>
    ...
    <section class="panel panel--garden stack">
      <div class="review-pot-card">
        <div class="review-pot-card__copy">
          <div class="status-strip">
            <span class="status-badge status-badge--done">ÃÂ©ÃÂÃÂ¸ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­</span>
            ${isHabit
              ? `<span class="status-badge">ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£</span>`
              : `<span class="status-badge ${isGoalAchieved(goal) ? "status-badge--done" : "status-badge--accent"}">${isGoalAchieved(goal) ? "ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : "ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­"}</span>`}
          </div>
          <div class="stack stack--tight">
            ...
            ${todayLog && isExecutionOutcome(todayLog.outcome)
              ? `<div class="review-pot-card__actions">
                  <button type="button" class="ghost-button" data-action="open-review-log-editor" data-log-id="${escapeHtml(todayLog.logId)}">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£</button>
                </div>`
              : ""}
          </div>
        </div>
        ...
        <div class="review-pot-card__facts">
          <div class="review-pot-card__fact">
            <span>${isHabit ? "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂ®ÃÂµÃÂ©ÃÂÃÂ" : "ÃÂ¥ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¹"}</span>
            <strong>${escapeHtml(isHabit ? bonsaiGrowth.stageLabel : flower.stageLabel)}</strong>
          </div>
          <div class="review-pot-card__fact">
            <span>${isHabit ? "ÃÂ§ÃÂ¶ÃÂÃÂ§ÃÂ¶ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ°" : "ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ¦ÃÂÃÂ°"}</span>
            <strong>${escapeHtml(`${isHabit ? bonsaiGrowth.executedDays : flower.executedDays}ÃÂ¦ÃÂÃÂ¥`)}</strong>
          </div>
          <div class="review-pot-card__fact">
            <span>${isHabit ? "ÃÂ§ÃÂÃÂ´ÃÂ¨ÃÂ¿ÃÂ7ÃÂ¥ÃÂÃÂ" : "ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ½ÃÂÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂÃÂ"}</span>
...
function renderReviewLogEditPanel() {
  ...
  const toggleLabel = ui.reviewLogExpanded ? "ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ£ÃÂÃÂ";
  ...
  return `
    <section class="panel stack">
      <div>
        <h2 class="section-title">ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£</h2>
      </div>
...
function renderReviewLogEditor(entry) {
  ...
  return `
    <div class="review-log-editor">
      <div class="status-strip">
        <span class="status-badge status-badge--accent">ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£ÃÂ¤ÃÂ¸ÃÂ­</span>
        <span class="status-badge">${escapeHtml(outcomeLabel(entry.outcome))}</span>
      </div>
      <div class="field-grid field-grid--two">
        <label class="field">
          <span class="field__label">ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂ¥</span>
      ...
      <div class="review-log-editor__actions">
        <button type="button" class="action-button action-button--primary" data-action="save-review-log">ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
        <button type="button" class="soft-button" data-action="cancel-review-log-edit">ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
      </div>
    </div>
  `;
}
...
function renderReviewLogCard(entry) {
  ...
  const detailParts = [
    entry.milestoneLabel ? `ÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ® ${entry.milestoneLabel}` : "",
    entry.progressText ? `ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂ ${entry.progressText}` : "",
    entry.reflection ? `ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¢ ${entry.reflection}` : "",
  ].filter(Boolean);
    ...
    <article class="review-log-card ${isEditing ? "is-active" : ""}">
      <div class="review-log-card__head">
        <div>
          ...
          <p class="review-log-card__meta">${escapeHtml(`${outcomeLabel(entry.outcome)} / ÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂ¡ÃÂ ${formatLoggedDuration(getLoggedSeconds(entry))}`)}</p>
        </div>
        <button type="button" class="ghost-button" data-action="open-review-log-editor" data-log-id="${escapeHtml(entry.logId)}">ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£</button>
      </div>
    ...
    <section class="screen">
      <div class="hero">
        <div class="hero__sticky">
          <div class="hero__accent"></div>
          <div class="status-strip">
            <span class="status-badge">ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­ ${growingGoals.length}</span>
            <span class="status-badge status-badge--done">ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿ ${archivedGoals.length}</span>
          </div>
        </div>
      </div>

      ${habitGoals.length ? renderGardenShelfSection("ÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂÃÂ¦ÃÂ ÃÂ½", "ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ¯ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ·ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", habitGoals, { emptyCopy: "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" }) : ""}
      ${renderGardenShelfSection("ÃÂ¤ÃÂ»ÃÂÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ±", "ÃÂ©ÃÂÃÂ²ÃÂ¨ÃÂ¡ÃÂÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", growingGoals, { emptyCopy: "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂÃÂ±ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" })}
      ${renderAchievementGardenSection("ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ±", "ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂºÃÂ­ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¦ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", archivedGoals, { emptyCopy: "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" })}
      ${renderAlbumSection()}
    </section>
  `;
}
...
function renderAlbumSection() {
  ...
  const cards = goals.map(goal => {
    ...
    if (isHabit) {
      ...
      subtitle = `${getBonsaiTypeMeta(goal.setup.bonsaiKey).label} / ${growth.stageIndex}ÃÂ¦ÃÂ®ÃÂµÃÂ©ÃÂÃÂ / ${growth.executedDays}ÃÂ¦ÃÂÃÂ¥ÃÂ©ÃÂÃÂ`;
    } else {
      const growth = getFlowerGrowth(goal.logs || []);
      const flower = getGoalFlowerState(goal);
      artwork = renderFlowerArtwork(flower.key, growth.stageIndex, { size: "card" });
      subtitle = `${flower.label} / ${growth.stageLabel} / ${growth.executedDays}ÃÂ¦ÃÂÃÂ¥ÃÂ©ÃÂÃÂ`;
    }
    ...
    return `
      <div class="album-card">
        ...
        <div class="album-card__body">
          ...
          ${archivedDate ? `<p class="album-card__date">${archivedDate} ÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂ</p>` : ""}
          ${isConfirm
            ? `<p class="album-card__warn">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
               <div class="album-card__actions">
                 <button class="soft-button" data-action="purge-archived-goal" data-goal-id="${goal.id}">ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                 <button class="soft-button" data-action="cancel-delete-goal">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
               </div>`
            : `<div class="album-card__actions">
                 <button class="soft-button album-card__delete" data-action="confirm-delete-goal" data-goal-id="${goal.id}">ÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂÃÂ¨ÃÂ¦ÃÂ¶ÃÂÃÂ¥ÃÂÃÂ»</button>
               </div>`}
        </div>
      </div>
    `;
  ...
  return `
    <section class="panel stack garden-album">
      <div>
        <h2 class="section-title">ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ </h2>
  ...
  if (!goals.length) {
    return `
      <section class="panel stack">
        ...
        <p class="preview-empty">${escapeHtml(options.emptyCopy || "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ")}</p>
      </section>
    `;
  }
    ...
    return `
      <div class="garden-card garden-card--bonsai">
        ...
        <div class="garden-card__body">
          ...
          <div class="garden-card__streak">${escapeHtml(`ÃÂ§ÃÂ¶ÃÂÃÂ§ÃÂ¶ÃÂ ${growth.executedDays}ÃÂ¦ÃÂÃÂ¥`)}&ensp;${renderStreakDots(goal.logs || [], goal.setup.studyDays)}</div>
        </div>
      </div>
    `;
  }
  ...
  return `
    <div class="garden-card ${completed ? "is-complete" : ""}">
      ...
      <div class="garden-card__body">
        <div class="garden-card__head">
          <strong class="garden-card__title">${escapeHtml(goal.setup.goal)}</strong>
          <span class="status-badge ${completed ? "status-badge--done" : ""}">${completed ? "ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : "ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­"}</span>
        </div>
        <p class="garden-card__meta">${escapeHtml(`${flower.label} / ${flower.stageLabel}`)}</p>
        <p class="garden-card__meta">${escapeHtml(`ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂ ${flower.executedDays}ÃÂ¦ÃÂÃÂ¥ / ÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂÃÂ ${roadmap.learningProgress}%`)}</p>
      </div>
    </div>
  `;
}
...
function renderAchievementGardenPlanter(goals, bedIndex, totalBeds = 1) {
  ...
  return `
    <section class="garden-planter ${totalBeds > 1 ? "garden-planter--stacked" : ""}" style="--plot-count:${goals.length}; --scene-position:${scenePosition}%; --scene-zoom:${sceneZoom}%;" aria-label="${escapeHtml(`ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂÃÂ±ÃÂ¥ÃÂ£ÃÂ ${bedIndex + 1}`)}">
  ...
  return `
    <article class="garden-plot ${isActive ? "is-active" : ""}">
      <details class="garden-plot__details">
        <summary class="garden-plot__touch" aria-label="${escapeHtml(`${goal.setup.goal} ÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ©ÃÂ³ÃÂ§ÃÂ´ÃÂ°ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂº`)}">
        ...
        <div class="garden-plot__tooltip" role="note">
          ...
          <div class="garden-plot__meta">${escapeHtml(`ÃÂ¨ÃÂÃÂ²ÃÂ¦ÃÂÃÂ ${flower.executedDays}ÃÂ¦ÃÂÃÂ¥ / ÃÂ©ÃÂÃÂ²ÃÂ¦ÃÂÃÂ ${roadmap.learningProgress}%`)}</div>
        </div>
      </details>
    </article>
  `;
  ...
  return `
    <section class="screen">
      <div class="hero">
        <div class="hero__accent"></div>
        ${renderActiveGoalContext()}
        <h1 class="hero__title">ÃÂ¨ÃÂÃÂªÃÂ§ÃÂÃÂ±ÃÂ©ÃÂÃÂÃÂ¨ÃÂ«ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ«ÃÂÃÂ£ÃÂÃÂ¦ÃÂ§ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</h1>
      </div>
      ...
      ${isRetargetMode ? `
        <section class="panel stack">
          <div>
            <h2 class="panel__title">ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¨RoadmapÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°</h2>
          </div>
          <label class="field">
            <span class="field__label">ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ</span>
      ...
      <section class="panel stack">
        <div>
          <h2 class="panel__title">ÃÂ§ÃÂÃÂ¸ÃÂ¨ÃÂ«ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ®ÃÂ¹</h2>
        </div>
        <label class="field">
          <textarea data-replan-field="text" placeholder="${isRetargetMode ? "ÃÂ¤ÃÂ¾ÃÂ: ChatGPTÃÂ£ÃÂÃÂ¨ÃÂ¥ÃÂÃÂÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¼ÃÂ·ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¯ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ¥ÃÂÃÂ°ÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ­ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¸ÃÂ£ÃÂÃÂ"}">${escapeHtml(state.replan.text || "")}</textarea>
        </label>
        <button type="button" class="action-button" data-action="generate-replan">ÃÂ¥ÃÂ·ÃÂ®ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂ</button>
      </section>

      <section class="panel stack">
        <div>
          <h2 class="panel__title">ÃÂ¥ÃÂ·ÃÂ®ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¼</h2>
        </div>
        ${
          preview.length
            ? `<ul class="preview-list">${preview.map((item) => `<li>${escapeHtml(item)}</li>`).join("")}</ul>`
            : `<p class="preview-empty">ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ¥ÃÂ·ÃÂ®ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>`
        }
      </section>

      <div class="action-row">
        <button type="button" class="soft-button" data-action="navigate" data-view="today">ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂ</button>
        <button type="button" class="action-button action-button--primary" data-action="apply-replan">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ©ÃÂ§ÃÂÃÂ¨</button>
      </div>
    </section>
  `;
}

function renderPlanCard(planKey, plan, recommendedPlan, recommendedLabel = "ÃÂ¦ÃÂÃÂ¨ÃÂ¥ÃÂ¥ÃÂ¨") {
  return `
    <article class="plan-card ${recommendedPlan === planKey ? "is-recommended" : ""}">
      <div class="plan-card__head">
        <div>
          ...
          <div class="plan-card__meta">${plan.minutes}ÃÂ¥ÃÂÃÂ</div>
        </div>
  ...
  return `
    <article class="plan-card plan-card--editable">
      ...
      <label class="plan-card__editor">
        ...
        <span class="plan-card__unit">ÃÂ¥ÃÂÃÂ</span>
      </label>
    </article>
  `;
}
...
function renderBonsaiPicker(selectedKey, actionName = "select-setup-bonsai") {
  ...
  return `
    <div class="field">
      <span class="field__label">ÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂÃÂ¦ÃÂ ÃÂ½</span>
      <p class="section-copy">ÃÂ§ÃÂÃÂÃÂ¦ÃÂ ÃÂ½ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂ¨ÃÂ®ÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</p>
...
// ============================================================
// ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ© SVGÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ¯ÃÂ¼ÃÂÃÂ¦ÃÂ¢ÃÂÃÂ£ÃÂÃÂ»ÃÂ¦ÃÂ¡ÃÂÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
// ============================================================
...
// ============================================================
// ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂ£ÃÂ¦ÃÂ¤ÃÂÃÂ§ÃÂÃÂ© SVGÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ¯ÃÂ¼ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ»ÃÂ¨ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
// ============================================================
...
// ============================================================
// ÃÂ¦ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¼ SVGÃÂ£ÃÂÃÂ¬ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ¯ÃÂ¼ÃÂÃÂ¤ÃÂºÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ§ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ
// ============================================================
...
function renderSunflowerFlowerSvg(flower, stage, stageRatio) {
  ...
  let blossom = "";
  if (stage < 3) {
    // ÃÂ§ÃÂ¨ÃÂ®ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ³: ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ°ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ¤ÃÂ¸ÃÂ¸ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ½/ÃÂ¨ÃÂÃÂ¾
    const r = 3.5 + stage * 1.5;
    blossom = `<circle cx="60" cy="${bY + 5}" r="${r}" fill="${flower.bud}" opacity="0.82"/>`;
  } else if (stage < 6) {
    // ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ²ÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂ: ÃÂ¨ÃÂÃÂ±ÃÂ¥ÃÂ¼ÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ¤ÃÂ¸ÃÂ¸ÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ
...
function renderSessionSheet() {
  ...
  const milestoneOptions = normalizeRoadmapItems(state.roadmap, state.setup)
    .map(
      (item) => `<option value="${escapeHtml(item.id)}" ${ui.finishDraft && ui.finishDraft.milestoneId === item.id ? "selected" : ""}>${escapeHtml(item.label)} / ÃÂ§ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂ ${item.target}%</option>`,
    )
    .join("");
      ...
      <div class="stack">
            ...
            .map(
              (key) => `
                <button type="button" class="pill-button ${displayPlanKey === key ? "is-active" : ""}" data-action="select-session-plan" data-plan="${key}">
                  ${PLAN_META[key].label}<br /><span class="muted">${state.plans[key].minutes}ÃÂ¥ÃÂÃÂ</span>
                </button>
              `,
            )
            .join("")}
            ...
            ? `
              <div class="panel panel--cool stack">
                <div class="elapsed-timer-wrap">
                  ...
                  />
                  <span class="elapsed-timer-unit">${ui.finishDraft.elapsedSeconds !== ui.finishDraft._originalElapsed ? formatLoggedDuration(ui.finishDraft.elapsedSeconds) : "ÃÂ¥ÃÂÃÂ:ÃÂ§ÃÂ§ÃÂ"}</span>
                </div>
                <p class="sheet__caption">ÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂ¡ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ / ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂ ${formatLoggedDuration(ui.finishDraft.plannedSeconds)} / ${PLAN_META[ui.finishDraft.outcome].label}<br><span style="opacity:0.6;font-size:0.78em">ÃÂ¢ÃÂÃÂ± ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£ÃÂ¯ÃÂ¼ÃÂÃÂ¤ÃÂ¾ÃÂ: 10 ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ 1:30ÃÂ¯ÃÂ¼ÃÂ</span></p>
              </div>
              <div class="panel stack">
                <h3 class="panel__title">ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ»ÃÂÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂ</h3>
                ...
                <div class="field-grid field-grid--two">
                  <label class="field">
                    ...
                    <select class="field__control" data-finish-field="milestoneId">
                      <option value="">ÃÂ¤ÃÂ»ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ</option>
                      ${milestoneOptions}
                    </select>
                  </label>
                  <label class="field">
                    <span class="field__label">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ®ÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂ±ÃÂ£ÃÂÃÂ</span>
                    <select class="field__control" data-finish-field="milestoneStatus">
                      <option value="working" ${ui.finishDraft.milestoneStatus === "working" ? "selected" : ""}>ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­</option>
                      <option value="complete" ${ui.finishDraft.milestoneStatus === "complete" ? "selected" : ""}>ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ</option>
                    </select>
                  </label>
                </div>` : ""}
                <label class="field">
                  <span class="field__label">ÃÂ£ÃÂÃÂ²ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨</span>
                  <textarea data-finish-field="reflection" placeholder="ÃÂ¤ÃÂ»ÃÂ»ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂ°ÃÂÃÂ£ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ¤ÃÂ¸ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ">${escapeHtml(ui.finishDraft.reflection)}</textarea>
                </label>
              </div>
            `
            : `
              <div class="panel panel--cool">
                ...
                <p class="sheet__timer" id="session-timer-value">${overtime ? "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ" : (ui.focusPausedAt ? "ÃÂ¢ÃÂÃÂ¸" : formatCountdown(remaining))}</p>
                ${(state.activeSession?.departures > 0) ? `<p style="font-size:0.78rem;opacity:0.55;text-align:center;margin:4px 0 0">ÃÂ©ÃÂÃÂ¢ÃÂ¨ÃÂÃÂ± ${state.activeSession.departures}ÃÂ¥ÃÂÃÂ<\/p>` : ""}
              </div>
            `
        }
        ...
        <div class="sheet__actions">
          ${
            ui.finishDraft
              ? `
                <button type="button" class="action-button action-button--primary" data-action="save-finish-log">ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                <button type="button" class="soft-button" data-action="cancel-finish">ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂ</button>
              `
              : state.activeSession
                ? `
                  <button type="button" class="action-button action-button--primary" data-action="complete-session">ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                  <button type="button" class="action-button" data-action="downgrade-session">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¨ÃÂ¨ÃÂ»ÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ§ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                  <button type="button" class="soft-button soft-button--danger" data-action="abort-session">åãæ¶ãï¼è¨é²ããªãï¼</button>
                `
                : `
                  <button type="button" class="action-button action-button--primary" data-action="begin-session">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ</button>
                  <button type="button" class="soft-button" data-action="close-session">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ§</button>
                `
          }
        </div>
      </div>
...
function sendFocusNotification() {
  ...
  if (Notification.permission === "granted") {
    new Notification("ÃÂ¢ÃÂÃÂ¸ ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ", { body: "StreakBonsaiÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", icon: "./bonsai-favicon.svg" });
  } else if (Notification.permission !== "denied") {
    Notification.requestPermission().then(p => {
      if (p === "granted") new Notification("ÃÂ¢ÃÂÃÂ¸ ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ¤ÃÂ¸ÃÂ­ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ", { body: "StreakBonsaiÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", icon: "./bonsai-favicon.svg" });
    });
  }
}
...
function resumeFocusSession() {
  ...
  showToast(`ÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ ÃÂ©ÃÂÃÂ¢ÃÂ¨ÃÂÃÂ±: ${d}ÃÂ¥ÃÂÃÂ`);
  startSessionTicker();
  saveState();
  render();
}
...
function showFocusLostOverlay() {
  ...
  if (!overlay) {
    ...
    overlay.innerHTML = '<div style="font-size:2.8rem">ÃÂ¢ÃÂÃÂ¸<\/div><p style="font-size:1.1rem;font-weight:700;margin:0">ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¦ÃÂ­ÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ<\/p><p style="font-size:0.88rem;opacity:0.75;margin:0">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¨ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ<\/p>';
...
function computeRoadmap(currentState) {
  ...
  const milestones = stagedMilestones.map((item) => ({
    ...
    state: item.isComplete ? "ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ¿" : currentMilestone && item.id === currentMilestone.id ? "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" : "ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  }));
...
function inferWindowState(currentState) {
  ...
  if (minute < primary.start) {
    return {
      badge: "ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ¯ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ",
      windowLabel: `ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${currentState.setup.primaryWindow}`,
      actionLabel: `ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ« ${PLAN_META[baselinePlan].label} ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ§ÃÂµÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ`,
      copy: "ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      tone: "accent",
  ...
  if (minute <= primary.end) {
    return {
      ...
      actionLabel: `ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ ${PLAN_META[baselinePlan].label} ÃÂ£ÃÂÃÂ§ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ§ÃÂµÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`,
      copy: "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¸ÃÂ¯ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      tone: "accent",
      planCap: baselinePlan,
    };
  }
  ...
  return {
    badge: "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂ¾ÃÂ",
    windowLabel: `ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ ${currentState.setup.primaryWindow}`,
    actionLabel: `ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ ${PLAN_META.C.label} ÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ¦ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ`,
    copy: "ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂµÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ¥ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ°ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    tone: "default",
    planCap: "C",
  };
}
...
function generateReviewSuggestions(metrics, currentState) {
  ...
  if (reasons.some((reason) => reason.includes("ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­"))) {
    suggestions.push("ÃÂ§ÃÂÃÂ«ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂPlan BÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  }

  if (metrics.rescueRate >= 20 || currentState.planTuning.rescuePrimaryDays.length > 0) {
    suggestions.push("ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ¦ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ»ÃÂ¦ÃÂÃÂ ÃÂ¦ÃÂÃÂ±ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  }

  if (reasons.some((reason) => reason.includes("ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂ"))) {
    suggestions.push("ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¯2ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  } else if (reasons.some((reason) => reason.includes("ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯"))) {
    suggestions.push("ÃÂ¥ÃÂ¤ÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ§ÃÂ³ÃÂ»ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂ¼ÃÂÃÂ§ÃÂ¿ÃÂÃÂ§ÃÂ³ÃÂ»ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  } else {
    suggestions.push("ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ¯ÃÂ¢ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  }

  while (suggestions.length < 3) {
    suggestions.push("ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯1ÃÂ¦ÃÂ®ÃÂµÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  }
...
function generateReplanPreview(mode, text, currentState) {
  ...
  const heavyReason = normalized.includes("ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­") || normalized.includes("ÃÂ¥ÃÂ¿ÃÂ");
  const fatigueReason = normalized.includes("ÃÂ§ÃÂÃÂ²") || normalized.includes("ÃÂ§ÃÂÃÂ ");
  const prepReason = normalized.includes("ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂ") || normalized.includes("ÃÂ©ÃÂÃÂ¢ÃÂ¥ÃÂÃÂ");
  ...
  if (mode === "retarget_goal") {
    ...
    return [
      `ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${currentState.setup.goal}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂ${retargeted.setup.goal}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°`,
      `ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ·ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${currentState.today.missionTitle}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂ${retargeted.today.missionTitle}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°`,
      `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${weekItem ? weekItem.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹"}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂ${nextWeek ? nextWeek.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹"}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°`,
      `ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${nextItem ? nextItem.label : "ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©"}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂ${nextRoadmapStep ? nextRoadmapStep.label : "ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©"}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ´ÃÂ¦ÃÂÃÂ°`,
      "ÃÂ¦ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®RoadmapÃÂ£ÃÂÃÂ¯ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂÃÂ£ÃÂÃÂ¨ÃÂ§ÃÂÃÂ¾ÃÂ¥ÃÂÃÂ¨ÃÂ¥ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ´ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    ];
  }

  if (mode === "lighten_today") {
    return [
      `ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ ${PLAN_META[todayPlan].label} -> ${PLAN_META[nextPlan].label} ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´`,
      `ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ·ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${currentState.today.missionTitle}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂ${shortenMission(currentState.today.missionTitle)}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ®`,
      heavyReason ? `ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ¤ÃÂ¸ÃÂ»ÃÂ¦ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂ  ${currentState.setup.backupWindow} ÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂªÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ§ÃÂ¤ÃÂº` : `ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂ®ÃÂÃÂ§ÃÂ¾ÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${currentState.plans.C.description}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ¥ÃÂÃÂºÃÂ¥ÃÂ®ÃÂ`,
    ];
  }

  if (mode === "reset_week") {
    return [
      `${weekdayLabel("Tue")}ÃÂ£ÃÂÃÂ®ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ Plan A -> Plan B ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´`,
      `${weekdayLabel("Fri")}ÃÂ£ÃÂÃÂ¯ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂÃÂ¦ÃÂÃÂ  ${currentState.setup.rescueWindow} ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ»ÃÂ¦ÃÂÃÂ ÃÂ¦ÃÂÃÂ±ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`,
      `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${weekItem ? weekItem.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹"}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ${lighterWeeklyFocus(weekItem ? weekItem.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ")}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¤ÃÂ¿ÃÂ®ÃÂ¦ÃÂ­ÃÂ£`,
    ];
  }

  if (mode === "break_goal") {
    return [
      `ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${nextItem ? nextItem.label : "ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©"}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂÃÂ¦ÃÂ¬ÃÂ¡: ${microStepFromMission(currentState.today.missionTitle)}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´`,
      `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${weekItem ? weekItem.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹"}ÃÂ£ÃÂÃÂ -> ÃÂ£ÃÂÃÂÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£`,
      `ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ¥ÃÂ­ÃÂ¦ÃÂ§ÃÂ¿ÃÂÃÂ¤ÃÂ¾ÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ${warmupExample(currentState.setup.minimumExample)}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ `,
    ];
  }

  return [
    heavyReason ? `ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ£ÃÂÃÂÃÂ§ÃÂ¶ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ${weekdayLabel("Tue")}ÃÂ£ÃÂÃÂ¨${weekdayLabel("Thu")}ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂPlan BÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´` : "ÃÂ¨ÃÂ©ÃÂ°ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂPlan BÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´",
    fatigueReason ? `ÃÂ©ÃÂÃÂÃÂ¥ÃÂ¸ÃÂ¸ÃÂ¥ÃÂ­ÃÂ¦ÃÂ§ÃÂ¿ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ ${currentState.setup.normalMinutes}ÃÂ¥ÃÂÃÂ -> ${Math.max(10, currentState.setup.normalMinutes - 5)}ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂªÃÂ¿ÃÂ¦ÃÂÃÂ´` : "ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ¥ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ£ÃÂÃÂ£ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¾ÃÂ¤ÃÂ¸ÃÂ»ÃÂ¦ÃÂÃÂ ÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂ²ÃÂ ÃÂ¨ÃÂÃÂ·ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    prepReason ? `ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ¥ÃÂÃÂ2ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${warmupExample(currentState.setup.minimumExample)}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ` : "ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ·ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ«2ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ",
  ];
}
...
function applyReplan(mode, preview) {
  ...
  if (mode === "lighten_today") {
    ...
    state.today.missionNote = `ÃÂ¤ÃÂ»ÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ¯ÃÂ¨ÃÂ»ÃÂ½ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¥ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${state.today.missionNote}`;
  ...
  if (mode === "reset_week") {
    ...
    state.roadmap = state.roadmap.map((item) =>
      item.id === "week" ? { ...item, label: `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ${lighterWeeklyFocus(item.label)}` } : item,
    );
    return;
  }
  ...
  if (mode === "break_goal") {
    state.roadmap = state.roadmap.map((item) => {
      if (item.id === "week") {
        return { ...item, label: "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ" };
      }
      if (item.id === "next") {
        return { ...item, label: `ÃÂ¦ÃÂ¬ÃÂ¡: ${microStepFromMission(state.today.missionTitle)}` };
      }
      return item;
    });
...
function buildPlans(setup, missionTitle) {
  ...
  return {
    A: {
      ...
      description: `${baseMission} + 1ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¿ÃÂÃÂ£ÃÂÃÂ`,
    },
    B: {
      minutes: shortMinutes,
      description: `${shortenMission(baseMission)}ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`,
    },
    C: {
      minutes: minimumMinutes,
      description: `${warmupExample(setup.minimumExample)}ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ`,
    },
  };
}
...
function buildInitialRoadmap(setup) {
  ...
  return orderRoadmapItems([
    ...
    { id: "week", kind: "system", target: ROADMAP_TARGETS.week, label: `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ${profile.weeklyFocus}`, deadline: "", note: "" },
    { id: "next", kind: "system", target: ROADMAP_TARGETS.next, label: `ÃÂ¦ÃÂ¬ÃÂ¡: ${profile.nextStepLabel}`, deadline: "", note: "" },
  ]);
}
...
function buildSeedState() {
  ...
  const setup = {
    goal: "3ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ«ÃÂ§ÃÂ°ÃÂ¿ÃÂ¨ÃÂ¨ÃÂ2ÃÂ§ÃÂ´ÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ ÃÂ¼",
    deadline: toISODate(deadline),
    currentLevel: "ÃÂ¥ÃÂÃÂÃÂ§ÃÂ°ÃÂ¿ 60% / ÃÂ¥ÃÂ·ÃÂ¥ÃÂ§ÃÂ°ÃÂ¿ 10%",
    ...
    shortMinutes: 10,
    minimumMinutes: 2,
    minimumExample: "ÃÂ¥ÃÂÃÂÃÂ¨ÃÂªÃÂ5ÃÂ¥ÃÂÃÂ / 1ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ / 1ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¸ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ",
  };
...
function buildSeedLogs(today) {
  const patterns = [
    ...
    { outcome: "miss", reason: "ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¢ÃÂ¥ÃÂÃÂ" },
    { outcome: "B", reason: "ÃÂ§ÃÂÃÂ²ÃÂ¥ÃÂÃÂ´" },
    { outcome: "A", reason: null },
    { outcome: "C", reason: "ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" },
    { outcome: "A", reason: null },
    { outcome: "miss", reason: "ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂÃÂ¥ÃÂ¤ÃÂÃÂ¦ÃÂÃÂ´" },
    { outcome: "A", reason: null },
    { outcome: "miss", reason: "ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­ÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" },
    { outcome: "B", reason: "ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ" },
    { outcome: "A", reason: null },
    { outcome: "C", reason: "ÃÂ§ÃÂÃÂ²ÃÂ¥ÃÂÃÂ´" },
    { outcome: "A", reason: null },
    { outcome: "A", reason: null },
  ];
  ...
  return patterns.map((pattern, index) => ({
    ...
    missionTitle: "ÃÂ§ÃÂÃÂ´ÃÂ¦ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ¤ÃÂ¾ÃÂ¡ÃÂ¨ÃÂ¨ÃÂÃÂ§ÃÂ®ÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¾ÃÂÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂ1ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ",
    recordedAt: new Date().toISOString(),
  }));
}
...
function normalizeRoadmapItems(items, setup) {
  if (Array.isArray(items)) {
    return orderRoadmapItems(items.map((item, index) => ({
      ...
      label: String(item.label || `ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ³ ${index + 1}`),
...
function getNextRoadmapItem(roadmap) {
  return roadmap.find((item) => item.id === "next")
    || roadmap.find((item) => String(item.label || "").startsWith("ÃÂ¦ÃÂ¬ÃÂ¡:"))
...
function commitGoalLibraryDraft() {
  ...
  const updatedGoal = createGoalRecord({
    ...
    replan: {
      ...
      weekDraft: stripRoadmapPrefix(weekly?.label || "", "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±:"),
      nextDraft: stripRoadmapPrefix(nextStep?.label || "", "ÃÂ¦ÃÂ¬ÃÂ¡:"),
    },
    logs: goal.logs,
...
function syncRetargetDraftFromState() {
  ...
  state.replan.weekDraft = stripRoadmapPrefix(weekly?.label || "", "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±:");
  state.replan.nextDraft = stripRoadmapPrefix(nextStep?.label || "", "ÃÂ¦ÃÂ¬ÃÂ¡:");
}
...
function buildRetargetResult(currentState) {
  ...
  const weekDraft = stripRoadmapPrefix(currentState.replan.weekDraft || "", "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±:");
  const nextDraft = stripRoadmapPrefix(currentState.replan.nextDraft || "", "ÃÂ¦ÃÂ¬ÃÂ¡:");

  if (weekDraft) {
    nextRoadmap = nextRoadmap.map((item) => (
      item.id === "week" ? { ...item, label: `ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±: ${weekDraft}` } : item
    ));
  }

  if (nextDraft) {
    nextRoadmap = nextRoadmap.map((item) => (
      item.id === "next" ? { ...item, label: `ÃÂ¦ÃÂ¬ÃÂ¡: ${nextDraft}` } : item
    ));
  }
...
function composeMissionNote(roadmap) {
  ...
  return `${weekly ? weekly.label : "ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¹"}ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂ®ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ1ÃÂ¦ÃÂÃÂ¬ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ${nextStep ? nextStep.label : "ÃÂ¦ÃÂ¬ÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ­ÃÂ©ÃÂ£ÃÂÃÂ¯RoadmapÃÂ£ÃÂÃÂ§ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¥ÃÂÃÂ ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ"}`;
}
...
function commitSetupDraft() {
  ...
  if (!primaryStart || !primaryEnd) {
    showToast("ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ¯ 05:30 ÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return null;
  }

  if (parseWindow(`${primaryStart}-${primaryEnd}`).start >= parseWindow(`${primaryStart}-${primaryEnd}`).end) {
    showToast("ÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ§ÃÂµÃÂÃÂ¤ÃÂºÃÂÃÂ£ÃÂÃÂ¯ÃÂ©ÃÂÃÂÃÂ¥ÃÂ§ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    return null;
  }
...
function importData(file) {
  ...
  reader.onload = (e) => {
    try {
      ...
      saveState();
      render();
      showToast("ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ¥ÃÂ¾ÃÂ©ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    } catch (_err) {
      showToast("ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ®ÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ¿ÃÂ¨ÃÂ¾ÃÂ¼ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂ¤ÃÂ±ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    }
  };
...
function startSessionTicker() {
  ...
  // Already running correctly ÃÂ¢ÃÂÃÂ don't reset the interval
  ...
  const updateTimerValue = () => {
    ...
    timerValue.textContent = remaining <= 0 ? "ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ" : formatCountdown(remaining);
  };
  ...
  ui.sessionTimer = window.setInterval(() => {
    ...
    if (remaining <= 0) {
      window.clearInterval(ui.sessionTimer);
      ui.sessionTimer = null;
      showToast("ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ»ÃÂ½ÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂ¸ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
    }
  }, 1000);
}
...
function parseElapsedInput(str) {
  const t = (str || "").trim();
  // "M:SS" format ÃÂ¢ÃÂÃÂ minutes:seconds
  ...
  // Plain number ÃÂ¢ÃÂÃÂ treated as minutes
...
function formatLoggedDuration(totalSeconds) {
  ...
  if (hours > 0) {
    return `${hours}ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ${String(minutes).padStart(2, "0")}ÃÂ¥ÃÂÃÂ`;
  }
  if (minutes > 0 && seconds === 0) {
    return `${minutes}ÃÂ¥ÃÂÃÂ`;
  }
  if (minutes > 0) {
    return `${minutes}ÃÂ¥ÃÂÃÂ${String(seconds).padStart(2, "0")}ÃÂ§ÃÂ§ÃÂ`;
  }
  return `${seconds}ÃÂ§ÃÂ§ÃÂ`;
}
...
function formatRemainingSpan(totalDays) {
  ...
  if (months <= 0) {
    return `${days}ÃÂ¦ÃÂÃÂ¥`;
  }
  if (days === 0) {
    return `${months}ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ`;
  }
  return `${months}ÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ${days}ÃÂ¦ÃÂÃÂ¥`;
}
function buildLogSummary(entry) {
  const parts = [outcomeLabel(entry.outcome)];
  const loggedSeconds = getLoggedSeconds(entry);
  if (loggedSeconds > 0) {
    parts.push(`ÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂ¡ÃÂ ${formatLoggedDuration(loggedSeconds)}`);
  }
  if (entry.milestoneLabel) {
    parts.push(`ÃÂ§ÃÂ¯ÃÂÃÂ§ÃÂÃÂ® ${entry.milestoneLabel}${entry.milestoneStatus === "complete" ? " ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ" : " ÃÂ©ÃÂÃÂÃÂ¤ÃÂ¸ÃÂ­"}`);
  }
  if (entry.progressText) {
    parts.push(`ÃÂ¥ÃÂÃÂ°ÃÂ©ÃÂÃÂ ${entry.progressText}`);
  }
  if (entry.reflection) {
    parts.push(`ÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¢ ${entry.reflection}`);
  }
  if (entry.reason) {
    parts.push(`ÃÂ§ÃÂÃÂÃÂ§ÃÂÃÂ± ${entry.reason}`);
  }
  return parts.join(" / ");
}
...
function isBlankCurrentLevel(currentLevel) {
  ...
  return !text || /^(ÃÂ¤ÃÂ½ÃÂÃÂ£ÃÂÃÂ(ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ|ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ|ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ)|ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ|ÃÂ¦ÃÂÃÂªÃÂ§ÃÂÃÂÃÂ¦ÃÂÃÂ|ÃÂ¦ÃÂÃÂªÃÂ¨ÃÂ¨ÃÂ­ÃÂ¥ÃÂ®ÃÂ|ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ­|0|0%)?[ÃÂ£ÃÂÃÂ.\s]*$/.test(text);
}
...
function getGoalProfile(setup) {
  ...
  if (goal.includes("ÃÂ§ÃÂ°ÃÂ¿ÃÂ¨ÃÂ¨ÃÂ")) {
    return {
      track: "ÃÂ§ÃÂ°ÃÂ¿ÃÂ¨ÃÂ¨ÃÂ2ÃÂ§ÃÂ´ÃÂ / ÃÂ¥ÃÂ·ÃÂ¥ÃÂ¦ÃÂ¥ÃÂ­ÃÂ§ÃÂ°ÃÂ¿ÃÂ¨ÃÂ¨ÃÂ",
      missionTitle: "ÃÂ§ÃÂÃÂ´ÃÂ¦ÃÂÃÂ¥ÃÂ¥ÃÂÃÂÃÂ¤ÃÂ¾ÃÂ¡ÃÂ¨ÃÂ¨ÃÂÃÂ§ÃÂ®ÃÂÃÂ£ÃÂÃÂ®ÃÂ¤ÃÂ¾ÃÂÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂ1ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ",
      foundationLabel: `${weakArea}ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨`,
      weeklyFocus: weakArea.includes("ÃÂ¥ÃÂ·ÃÂ¥") ? "CVPÃÂ§ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£" : `${weakArea}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ`,
      checkpointLabel: "ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ©ÃÂ¦ÃÂ£ÃÂÃÂ§70%",
      nextStepLabel: "ÃÂ¤ÃÂ¾ÃÂÃÂ©ÃÂ¡ÃÂ1ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    };
  }

  if (goal.includes("ITÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ")) {
    return {
      track: "ITÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ / ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ",
      missionTitle: blankLevel ? "ÃÂ§ÃÂÃÂ¨ÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ10ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂ»ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ3ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ¦ÃÂ£ÃÂÃÂ" : "ÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂ»ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ5ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂ¨ÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂ¾ÃÂ£ÃÂÃÂ",
      foundationLabel: blankLevel ? "3ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂ¨ÃÂ¤ÃÂ½ÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨" : `${weakArea}ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨`,
      weeklyFocus: blankLevel ? "ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¸ÃÂ§ÃÂ³ÃÂ»ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ" : `${weakArea}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ`,
      checkpointLabel: "ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ©ÃÂ¦ÃÂ£ÃÂÃÂ§700ÃÂ§ÃÂÃÂ¹",
      nextStepLabel: "ÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂ»ÃÂ¥ÃÂÃÂ3ÃÂ¥ÃÂÃÂ",
    };
  }

  if (goal.includes("ÃÂ¨ÃÂÃÂ±ÃÂ¨ÃÂªÃÂ")) {
    return {
      track: "ÃÂ¨ÃÂÃÂ±ÃÂ¨ÃÂªÃÂ / ÃÂ¨ÃÂªÃÂ­ÃÂ¨ÃÂ§ÃÂ£",
      missionTitle: "ÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ1ÃÂ©ÃÂ¡ÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂ3ÃÂ¨ÃÂ¡ÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
      foundationLabel: blankLevel ? "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨" : `${weakArea}ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨`,
      weeklyFocus: blankLevel ? "ÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ" : `${weakArea}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ`,
      checkpointLabel: "ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¨ÃÂ©ÃÂ¦ÃÂ£ÃÂÃÂ§70%",
      nextStepLabel: "ÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂ1ÃÂ©ÃÂ¡ÃÂ",
    };
  }

  const goalLabel = goal.replace(/ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ ÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ|ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ|ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ ÃÂ¼|ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂ/g, "").trim() || "ÃÂ§ÃÂÃÂ®ÃÂ¦ÃÂ¨ÃÂ";
  return {
    track: blankLevel ? goalLabel : `${goalLabel} / ${weakArea}`,
    missionTitle: blankLevel ? `${goalLabel}ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®1ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ§ÃÂ¦ÃÂ£ÃÂÃÂ` : `${weakArea}ÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®1ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ§ÃÂ¦ÃÂ£ÃÂÃÂ`,
    foundationLabel: blankLevel ? "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨" : `${weakArea}ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¥ÃÂÃÂ¨`,
    weeklyFocus: blankLevel ? "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂÃÂ£ÃÂÃÂ«ÃÂ¨ÃÂ§ÃÂ¦ÃÂ£ÃÂÃÂ" : `${weakArea}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ`,
    checkpointLabel: goal.includes("ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ ÃÂ¼") ? "ÃÂ¤ÃÂ¸ÃÂ­ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ©ÃÂÃÂ" : "ÃÂ¤ÃÂ¸ÃÂ­ÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂ§ÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
    nextStepLabel: "ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®1ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ",
  };
}
...
function detectWeakArea(currentLevel) {
  if (isBlankCurrentLevel(currentLevel)) {
    return "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ";
  }
  ...
  const scoredSegments = segments
    .map((segment) => {
      ...
      return match
        ? { label: segment.replace(/\d+%?/, "").trim() || "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ", score: Number(match[1]) }
        : null;
    })
    .filter(Boolean);
  ...
  return scoredSegments[0].label || "ÃÂ¥ÃÂÃÂºÃÂ§ÃÂ¤ÃÂ";
}
...
function shortReason(reason) {
  if (reason.includes("ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­")) return "ÃÂ¦ÃÂ®ÃÂÃÂ¦ÃÂ¥ÃÂ­";
  if (reason.includes("ÃÂ£ÃÂÃÂ¿ÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯")) return "ÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ";
  if (reason.includes("ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂ")) return "ÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂ";
  if (reason.includes("ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂ")) return "ÃÂ¤ÃÂºÃÂÃÂ¥ÃÂ®ÃÂ";
  if (reason.includes("ÃÂ§ÃÂÃÂ²")) return "ÃÂ§ÃÂÃÂ²ÃÂ¥ÃÂÃÂ´";
  return reason;
}

function shortenMission(mission) {
  if (mission.includes("1ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ")) {
    return mission.replace("1ÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ", "ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ");
  }
  if (mission.includes("ÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ")) {
    return mission.replace("ÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ", "ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£ÃÂ£ÃÂÃÂ");
  }
  if (mission.includes("ÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ")) {
    return mission.replace("ÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ", "ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂªÃÂ­ÃÂ£ÃÂÃÂ");
  }
  return `${mission}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ`;
}

function lighterWeeklyFocus(label) {
  const clean = label.replace(/^ÃÂ¤ÃÂ»ÃÂÃÂ©ÃÂÃÂ±:\s*/, "");
  if (clean.includes("ÃÂ§ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£")) {
    return clean.replace("ÃÂ§ÃÂÃÂÃÂ¨ÃÂ§ÃÂ£", "ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ");
  }
  return `${clean}ÃÂ£ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ`;
}

function microStepFromMission(mission) {
  if (mission.includes("ÃÂ¤ÃÂ¾ÃÂÃÂ©ÃÂ¡ÃÂ")) {
    return "ÃÂ¤ÃÂ¾ÃÂÃÂ©ÃÂ¡ÃÂ1ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ";
  }
  if (mission.includes("ÃÂ©ÃÂÃÂ·ÃÂ¦ÃÂÃÂ")) {
    return "ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ®1ÃÂ¦ÃÂ®ÃÂµÃÂ¨ÃÂÃÂ½ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ";
  }
  return `${mission}ÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂ`;
}

function warmupExample(example) {
  if (!example) return "ÃÂ¦ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦2ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ";
  if (example.includes("1ÃÂ¥ÃÂÃÂ")) {
    return "ÃÂ¥ÃÂÃÂ¬ÃÂ¥ÃÂ¼ÃÂÃÂ£ÃÂÃÂ1ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¨ÃÂ¦ÃÂÃÂ¨ÃÂ¿ÃÂÃÂ£ÃÂÃÂ";
  }
  return "ÃÂ¦ÃÂÃÂºÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦2ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¦ÃÂºÃÂÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ";
}
...
function shortenGoal(goal, limit = 16) {
  ...
  return safeGoal.length > limit ? `${safeGoal.slice(0, limit)}ÃÂ¢ÃÂÃÂ¦` : safeGoal;
}

function outcomeLabel(outcome) {
  if (outcome === "A") return "Plan AÃÂ£ÃÂÃÂ§ÃÂ¥ÃÂ®ÃÂÃÂ¤ÃÂºÃÂ";
  if (outcome === "B") return "Plan BÃÂ£ÃÂÃÂ§ÃÂ§ÃÂÃÂ­ÃÂ§ÃÂ¸ÃÂ®";
  if (outcome === "C") return "Plan CÃÂ£ÃÂÃÂ§ÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¸ÃÂ";
  if (outcome === "miss") return "ÃÂ¦ÃÂÃÂªÃÂ¥ÃÂ®ÃÂÃÂ¦ÃÂÃÂ½";
  return "ÃÂ¦ÃÂÃÂªÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ²";
}
...
function logSymbol(outcome) {
  ...
  if (outcome === "miss") return "ÃÂ¦ÃÂÃÂª";
  return "-";
}

function logSmallLabel(outcome) {
  if (outcome === "A") return "ÃÂ¤ÃÂ¸ÃÂ»";
  if (outcome === "B") return "ÃÂ¤ÃÂºÃÂ";
  if (outcome === "C") return "ÃÂ¦ÃÂÃÂ";
  if (outcome === "miss") return "ÃÂ¤ÃÂ¼ÃÂ";
  return "";
}
...
function shortWeekday(dateString) {
  ...
  return ["ÃÂ¦ÃÂÃÂ¥", "ÃÂ¦ÃÂÃÂ", "ÃÂ§ÃÂÃÂ«", "ÃÂ¦ÃÂ°ÃÂ´", "ÃÂ¦ÃÂÃÂ¨", "ÃÂ©ÃÂÃÂ", "ÃÂ¥ÃÂÃÂ"][date.getDay()];
}
...
function normalizeTimeValue(value) {
  const raw = String(value || "").trim().replace(/[ÃÂ¯ÃÂ¼ÃÂ]/g, ":");
  if (!raw) {
    return "";
  }
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Supabase ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ«ÃÂ¥ÃÂÃÂÃÂ¦ÃÂÃÂ ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Auth UI ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
function _switchAuthMode(mode) {
  ...
  // ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ1ÃÂ¥ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ¤ÃÂ½ÃÂÃÂ¦ÃÂÃÂ
  if (!document.querySelector("#auth-reset-link")) {
    const p = document.createElement("p");
    p.className = "auth-hint";
    p.id = "auth-reset-link";
    p.innerHTML = `<button type="button" class="auth-switch" id="auth-reset-btn">ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¥ÃÂ¿ÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ</button>`;
    _authHintEl.insertAdjacentElement("afterend", p);
  }
  const resetLink = document.querySelector("#auth-reset-link");

  if (mode === "login") {
    _authSubmitEl.textContent = "ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³";
    _authTabBtns.forEach(b => b.classList.toggle("is-active", b.dataset.authTab === "login"));
    _authHintEl.innerHTML = `ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ <button type="button" class="auth-switch" id="auth-switch-btn">ÃÂ¦ÃÂÃÂ°ÃÂ¨ÃÂ¦ÃÂÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ</button>`;
    resetLink.hidden = false;
  } else if (mode === "signup") {
    _authSubmitEl.textContent = "ÃÂ¦ÃÂÃÂ°ÃÂ¨ÃÂ¦ÃÂÃÂ§ÃÂÃÂ»ÃÂ©ÃÂÃÂ²";
    _authTabBtns.forEach(b => b.classList.toggle("is-active", b.dataset.authTab === "signup"));
    _authHintEl.innerHTML = `ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ§ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¢ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ®ÃÂ¦ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ <button type="button" class="auth-switch" id="auth-switch-btn">ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ</button>`;
    resetLink.hidden = true;
  } else if (mode === "reset") {
    _authSubmitEl.textContent = "ÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂ";
    _authTabBtns.forEach(b => b.classList.remove("is-active"));
    _authHintEl.innerHTML = `<button type="button" class="auth-switch" id="auth-switch-btn">ÃÂ¢ÃÂÃÂ ÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂ«ÃÂ¦ÃÂÃÂ»ÃÂ£ÃÂÃÂ</button>`;
    resetLink.hidden = true;
  }
  _rebindSwitchBtn();
}
...
_authForm.addEventListener("submit", async (e) => {
  ...
  try {
    if (_authMode === "login") {
      ...
      // Credential Management API: ChromeÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ¥ÃÂ­ÃÂÃÂ£ÃÂÃÂÃÂ¤ÃÂ¿ÃÂÃÂ£ÃÂÃÂ
      ...
      if (error) throw error;
      _authShowError("ÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ§ÃÂ¢ÃÂºÃÂ¨ÃÂªÃÂÃÂ£ÃÂÃÂ®ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ­ÃÂ£ÃÂÃÂ°ÃÂ£ÃÂÃÂ¤ÃÂ£ÃÂÃÂ³ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¦ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
      return;
      ...
      if (error) throw error;
      _authShowError("ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¹ÃÂ£ÃÂÃÂ¯ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂªÃÂ£ÃÂÃÂ»ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¡ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂ«ÃÂ£ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¤ÃÂ¿ÃÂ¡ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
      return;
    }
  } catch (err) {
    _authShowError(err.message || "ÃÂ£ÃÂÃÂ¨ÃÂ£ÃÂÃÂ©ÃÂ£ÃÂÃÂ¼ÃÂ£ÃÂÃÂÃÂ§ÃÂÃÂºÃÂ§ÃÂÃÂÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ¾ÃÂ£ÃÂÃÂÃÂ£ÃÂÃÂ");
  } finally {
    _authSetLoading(false);
  }
});

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Auth state ÃÂ£ÃÂÃÂ®ÃÂ§ÃÂÃÂ£ÃÂ¨ÃÂ¦ÃÂ ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
